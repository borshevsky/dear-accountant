...
from commands import party, waste, payoff, finish, add, remove, reset, members, money, help, song
...
def main():
    ...
    dispatcher.add_handler(CommandHandler('reset', reset, pass_args=True, pass_chat_data=True))
